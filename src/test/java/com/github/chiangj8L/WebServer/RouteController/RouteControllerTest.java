...
public class RouteControllerTest {
    ...
    public final void handleCallsLambdaOperation() throws Exception {
        ...
        // 1. Initialize the com.github.chiangj8L.WebServer.Route Controller.
        RouteController routeController = new RouteController(mockControllerLambda);

        // 2. Create mock com.github.chiangj8L.WebServer.Request and com.github.chiangj8L.WebServer.Response objects to pass into the handle function.
        IRequest mockRequest = new RequestMock();
        IResponse mockResponse = new ResponseMock();

        // 3. Call com.github.chiangj8L.WebServer.RouteController handle method.
